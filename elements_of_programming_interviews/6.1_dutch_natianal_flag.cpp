...
inline auto random_vector()
{
    ...
    v.insert(v.begin() + random_index, 3, *(v.begin() + random_index));
    random_index = std::rand() % static_cast<int>(v.size() - 1);
    v.insert(v.begin() + random_index, 2, *(v.begin() + random_index));
